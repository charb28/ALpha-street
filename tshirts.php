...
<body>
    <?php HeaderPage("./images/logo_tshrits.png", "Alpha Street");?>
    <main>
...
$resultat = $statement->execute(["tshirts"]);
...
foreach ($produits as $produit) {
    ...
    <div class=\"item-box-img\">
        <img src=\"./images/produits/tshirts/{$produit['image_produit']}\" class=\"item-img\" />
    </div>
