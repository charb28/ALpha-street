...
<head>
    ...
    <link rel="stylesheet" href="./styles/ensemble.css">
...
<body>
    <?php HeaderPage("./images/ensemble-1.png", "Alpha Street");?>
    <main>
...
$resultat = $statement->execute(["ensemble"]);
...
foreach ($produits as $produit) {
    ...
    <div class=\"item-box-img\">
        <img src=\"./images/produits/ensembles/{$produit['image_produit']}\" class=\"item-img\" />
    </div>
