...
<head>
    ...
    <link rel="stylesheet" href="./styles/sneakers.css">
...
<body>
    <?php HeaderPage("./images/sneakers_head.png", "Alpha Street");?>
    <main>
...
$statement = $conn->prepare('select * from produit where type_produit = ?');

$resultat = $statement->execute(["sneakers"]);
...
foreach ($produits as $produit) {
    ...
    <div class=\"item-box-img\">
        <img src=\"./images/produits/sneakers/{$produit['image_produit']}\" class=\"item-img\" />
    </div>
